...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 border-t border-border/70 px-6 py-4", className)}
      {...props}
    />
  )
}
